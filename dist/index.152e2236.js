var Synth, AudioSynth1, AudioSynthInstrument;
!function() {
    ...
    AudioSynth1 = function AudioSynth() {
    ...
    setPriv = setPrivateVar.bind(AudioSynth1.prototype);
    setPub = setPublicVar.bind(AudioSynth1.prototype);
    ...
    setPub('generate', function(sound, note, octave, duration) {
        ...
        if (!thisSound) {
            for(var i = 0; i < this._sounds.length; i++)if (this._sounds[i].name == sound) {
    ...
    AudioSynthInstance = new AudioSynth1();
...
//# sourceMappingURL=index.152e2236.js.map
